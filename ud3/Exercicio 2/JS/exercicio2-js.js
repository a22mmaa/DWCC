...
const hoxe = new Date();
const finDeCurso = new Date(2024, 5, 25);
const diasRestantes = Math.ceil((finDeCurso - hoxe) / (1000 * 60 * 60 * 24));
document.write(diasRestantes);
