var contrasinal = prompt('Introduce contrasinal') || 'Contrasinal-por-defecto111';
if (contrasinal.length >= 8 && contrasinal.length <= 16) {
    document.write('Perfecto! O contrasinal cumpre co tamaño obrigatorio.<br/>');
}
else {
    document.write('Por favor, revisa o tamaño do contrasinal. Recorda que debe ter entre 8 e 16 caracteres.<br/>');
}
...
var charEs;
var erroCaracterEspecial = false;
for (var _i = 0, caracteresEspeciais_1 = caracteresEspeciais; _i < caracteresEspeciais_1.length; _i++) {
    charEs = caracteresEspeciais_1[_i];
...
if (erroCaracterEspecial == false) {
    document.write('Recorda que debe ter ao menos un carácter especial (_, -, @, #, $, %, & ou …).<br/>');
}
