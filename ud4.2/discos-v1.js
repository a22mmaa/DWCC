// Construtor
function Disco(titulo, artista, ano, tipo, prestado) {
    this.titulo = titulo;
...
// Cargar datos no disco
Disco.prototype.cargarDatos = function (titulo, artista, ano, tipo, prestado) {
    this.titulo = titulo;
    this.artista = artista;
    this.ano = ano;
    this.tipo = tipo;
...
// Mostrar información
Disco.prototype.imprimir = function () {
